		...
		if product_schema:
			...
			if type(product_schema['product']['name']['language']) == list:
				for i in range(len(product_schema['product']['name']['language'])):
					product_schema['product']['name']['language'][i]['value'] = _unescape(template_data.name)
					product_schema['product']['link_rewrite']['language'][i]['value'] = self._get_link_rewrite('', template_data.name)
					product_schema['product']['description']['language'][i]['value'] =_unescape(template_data.description)
					product_schema['product']['description_short']['language'][i]['value'] = _unescape(template_data.description_sale)
			else:
				product_schema['product']['name']['language']['value'] = _unescape(template_data.name)
				product_schema['product']['link_rewrite']['language']['value'] = self._get_link_rewrite('', template_data.name)
				product_schema['product']['description']['language']['value'] = _unescape(template_data.description)
				product_schema['product']['description_short']['language']['value'] =_unescape(template_data.description_sale)
		...
		if type(product_data['product']['name']['language']) == list:
			for i in range(len(product_data['product']['name']['language'])):
				...
				if presta_lang_id == str(ps_lang_id):
					product_data['product']['name']['language'][i]['value'] = _unescape(tmpl_id.name or '')
					product_data['product']['description']['language'][i]['value'] =_unescape(tmpl_id.description or '')
					product_data['product']['description_short']['language'][i]['value'] =_unescape(tmpl_id.description_sale or '')
		else:
			product_data['product']['name']['language']['value'] = _unescape(tmpl_id.name or '')
			product_data['product']['description']['language']['value'] =_unescape(tmpl_id.description or '')
			product_data['product']['description_short']['language']['value'] =_unescape(tmpl_id.description_sale or '')
