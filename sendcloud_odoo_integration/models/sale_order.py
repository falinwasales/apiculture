    ...
    def get_locations(self):
        ...
        try:
            try:
                ...
                carrier_code = self.carrier_id.sendcloud_service_id.sendcloud_carrier_name if self.carrier_id.sendcloud_service_id.sendcloud_carrier_name  else "mondial_relay"
